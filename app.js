...
var UIcontroller = (function(){
    ...
    return {
        ...
        displayPercentages: function(percentages){
            ...
            var nodeListForEach = function(list, callbakck){
...
var controller = (function(budgetCtl, UIctl){
    ...
    document.querySelector(DOM.inputAdd).addEventListener('click', ctlAddItems);
    ...
    var ctlAddItems = function(){
        ...
        if(input.description !== '' && !isNaN(input.value) && input.value > 0){
            ...
            newItem = budgetCtl.addItems(input.type, input.description, input.value);
